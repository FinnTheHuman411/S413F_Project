...
public class Activity_Movie1 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "owNYJ4Y9z3o";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(1, 1, "Laid-Back Camp Movie", 80, R.drawable.m1);
    }
