...
public class Activity_Movie19 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "8Qn_spdM5Zg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie19);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(19, 1, "Star Wars: The Rise of Skywalker", 77, R.drawable.m19);
    }
