...
public class Activity_Movie10 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "orAqhC-Hp_o";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie10);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(10, 1, "Madagascar", 40, R.drawable.m10);
    }
