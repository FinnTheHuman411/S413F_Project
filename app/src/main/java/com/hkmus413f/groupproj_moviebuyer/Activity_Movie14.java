...
public class Activity_Movie14 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "xU47nhruN-Q";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(14, 1, "Your Name", 69, R.drawable.m14);
    }
