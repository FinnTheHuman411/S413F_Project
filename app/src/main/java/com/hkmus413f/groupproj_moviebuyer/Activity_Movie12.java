...
public class Activity_Movie12 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "fe-luzrqWSk";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(12, 1, "Bruce Almighty", 38, R.drawable.m12);
    }
