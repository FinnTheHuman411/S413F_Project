...
public class Activity_Movie9 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "TcMBFSGVi1c";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(9, 1, "Avengers: Endgame", 72, R.drawable.m9);
    }
