...
public class Activity_Movie13 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "JfVOs4VSpmA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie13);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(13, 1, "Spider-Man: No Way Home", 78, R.drawable.m13);
    }
