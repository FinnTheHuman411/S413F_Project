...
public class Activity_Movie15 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "OFVGCUIXJls";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie15);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(15, 1, "Charlie and the Chocolate Factory", 40, R.drawable.m15);
    }
