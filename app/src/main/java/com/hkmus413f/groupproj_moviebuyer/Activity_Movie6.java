...
public class Activity_Movie6 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "yVF4pXHAEAI";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(1, 1, "YuruYuri Nachuyachumi", 49, R.drawable.m6);
    }
