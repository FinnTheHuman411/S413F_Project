...
public class Activity_Movie17 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "9ix7TUGVYIo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie17);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(17, 1, "The Matrix Resurrections", 82, R.drawable.m17);
    }
