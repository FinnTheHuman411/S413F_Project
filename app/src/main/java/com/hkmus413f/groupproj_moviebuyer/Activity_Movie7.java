...
public class Activity_Movie7 extends AppCompatActivity implements YouTubePlayer.OnInitializedListener {

    private static final String VIDEO_ID = "htvYfe6wz_8";
    ...
    public void btn_add(View v){
        add_to_shopping_cart(7, 1, "Downfall", 43, R.drawable.m7);
    }
